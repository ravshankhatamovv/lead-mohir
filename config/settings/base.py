...
if USE_S3:
    ...
    MEDIA_URL = 'https://cdn.leetcode.uz/media/'
...
ADMINS = [("""Empire""", "productgsm@gmail.com")]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [
        'rest_framework.throttling.AnonRateThrottle',   # anonymous users uchun
        'rest_framework.throttling.UserRateThrottle',   # authenticated users uchun
    ],
    'DEFAULT_THROTTLE_RATES': {
        'anon': '10/minute',     # anonim foydalanuvchi uchun limit
        'user': '100/hour',      # login bo‘lgan foydalanuvchi uchun limit
    }
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Your CRM API",
    "DESCRIPTION": "Documentation of API endpoints of Your CRM",
    "VERSION": "1.0.0",
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "apps.account.serializers.MyTokenObtainPairSerializer",
    'ALGORITHM': 'HS256',
    'TOKEN_TYPE_CLAIM': 'token_type',
}

# UPLOADING FILE DATA SIZE
